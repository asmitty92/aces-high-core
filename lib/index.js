...
var Card = (function () {
    ...
    Card[_a] = { fqn: "aces-high-core.Card", version: "2.2.2" };
    return Card;
}());
exports.Card = Card;
var DeckOfCards = (function () {
    ...
    DeckOfCards[_b] = { fqn: "aces-high-core.DeckOfCards", version: "2.2.2" };
    return DeckOfCards;
}());
...
var StandardDeck = (function (_super) {
    ...
    function StandardDeck() {
        ...
        var index = 0;
        for (var _i = 0, _d = Object.keys(Suits); _i < _d.length; _i++) {
            var suitKey = _d[_i];
            for (var _e = 0, _f = Object.keys(Faces); _e < _f.length; _e++) {
                var faceKey = _f[_e];
                _this.cards.push(new Card(Suits[suitKey], Faces[faceKey], index++));
            }
        }
        return _this;
    }
    ...
    StandardDeck[_c] = { fqn: "aces-high-core.StandardDeck", version: "2.2.2" };
    return StandardDeck;
}(DeckOfCards));
...
var CardHand = (function () {
    ...
    CardHand[_d] = { fqn: "aces-high-core.CardHand", version: "2.2.2" };
    return CardHand;
}());
...
var CardPlayer = (function () {
    ...
    CardPlayer[_e] = { fqn: "aces-high-core.CardPlayer", version: "2.2.2" };
    return CardPlayer;
}());
