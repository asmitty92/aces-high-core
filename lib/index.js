...
var StandardDeck = (function () {
    ...
    StandardDeck.prototype.randomShuffle = function () {
        for (var i = 0; i < this.numberOfCards(); i++) {
            var swapIndex = this.getRandomIndex(0, this.numberOfCards());
...
var indexOn = function (arr, key) {
    return arr.reduce(function (obj, v) {
        var _a;
        var _b = v, _c = key, id = _b[_c], data = __rest(_b, [typeof _c === "symbol" ? _c : _c + ""]);
        console.log('v', v);
        console.log('data', data);
        console.log('object', __assign((_a = {}, _a[key] = id, _a), data));
        obj[id] = data;
        return obj;
    }, {});
};
...
console.log(indexOn([
    new Card(Suits.SPADES, Faces.TWO, 27),
    new Card(Suits.SPADES, Faces.ACE, 26)
], 'suit'));
