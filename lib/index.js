...
var Card = (function () {
    ...
    Card[_b] = { fqn: "aces-high-core.Card", version: "2.0.0" };
    return Card;
}());
exports.Card = Card;
var StandardDeck = (function () {
    ...
    StandardDeck[_c] = { fqn: "aces-high-core.StandardDeck", version: "2.0.0" };
    return StandardDeck;
}());
...
var CardHand = (function () {
    ...
    CardHand[_d] = { fqn: "aces-high-core.CardHand", version: "2.0.0" };
    return CardHand;
}());
...
var CardPlayer = (function () {
    ...
    CardPlayer[_e] = { fqn: "aces-high-core.CardPlayer", version: "2.0.0" };
    return CardPlayer;
}());
