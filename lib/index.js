...
var Card = (function () {
    ...
    Card[_a] = { fqn: "aces-high-core.Card", version: "2.5.0" };
    return Card;
}());
exports.Card = Card;
var DeckOfCards = (function () {
    ...
    DeckOfCards.prototype.riffleShuffle = function () {
        ...
        while (topIndex < top.length || bottomIndex < bottom.length) {
            var startWithTop = this.coinFlip() === 0;
            if (startWithTop) {
                var chunkSize = this.getRandomIndex(1, 3);
                for (var i = 0; i < chunkSize && topIndex < top.length; i++) {
                    shuffled.push(top[topIndex++]);
                }
                var otherChunkSize = this.getRandomIndex(1, 3);
                for (var i = 0; i < otherChunkSize && bottomIndex < bottom.length; i++) {
                    shuffled.push(bottom[bottomIndex++]);
                }
            }
            else {
                var chunkSize = this.getRandomIndex(1, 3);
                for (var i = 0; i < chunkSize && bottomIndex < bottom.length; i++) {
                    shuffled.push(bottom[bottomIndex++]);
                }
                var otherChunkSize = this.getRandomIndex(1, 3);
                for (var i = 0; i < otherChunkSize && topIndex < top.length; i++) {
                    shuffled.push(top[topIndex++]);
                }
            }
        }
    ...
    DeckOfCards.prototype.fullShuffle = function () {
        ...
        for (var i = 0; i < totalShuffles; i++) {
            var random = this.getRandomIndex(1, 5);
            if (random === 5) {
    ...
    DeckOfCards[_b] = { fqn: "aces-high-core.DeckOfCards", version: "2.5.0" };
    return DeckOfCards;
}());
...
var StandardDeck = (function (_super) {
    ...
    StandardDeck[_c] = { fqn: "aces-high-core.StandardDeck", version: "2.5.0" };
    return StandardDeck;
}(DeckOfCards));
...
var CardHand = (function () {
    ...
    CardHand[_d] = { fqn: "aces-high-core.CardHand", version: "2.5.0" };
    return CardHand;
}());
...
var CardPlayer = (function () {
    ...
    CardPlayer[_e] = { fqn: "aces-high-core.CardPlayer", version: "2.5.0" };
    return CardPlayer;
}());
